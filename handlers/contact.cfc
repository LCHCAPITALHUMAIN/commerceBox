<cfcomponent name="contact" extends="coldbox.system.eventhandler" output="false">
	...
	<cffunction name="index" access="public" returntype="void" output="false">
		...
		<cfset rc.title="Contact #getController().getSetting("siteName")#">
		<cfset rc.description="Contact information for #getController().getSetting("siteName")#" >
		<cfset rc.keywords="contact, phone, #getController().getSetting("siteName")#">
	...
	<cffunction name="prayer" access="public" returntype="void" output="false">
		<cfargument name="event" required="yes">
		<cfset var rc = event.getCollection()>
		<cfset title="Send Prayer Requests to #getController().getSetting("siteName")#">
		<cfset description="Submit your prayer request to have the #getController().getSetting("siteName")# staff pray for you" >
		<cfset keywords="prayer, contact, #getController().getSetting("siteName")#, Stephen Wallace">
	...
	<cffunction name="studies" access="public" returntype="void" output="false">
		<cfargument name="event" required="yes">
		<cfset var rc = event.getCollection()>
		<cfset title="Bibles studies with Junie - #getController().getSetting("siteName")#">
		<cfset description="Online Bible studies with Bible Instructor for #getController().getSetting("siteName")#" >
		<cfset keywords="bible, studies, guides, lessons, prophecy, #getController().getSetting("siteName")#, Stephen Wallace, ">
		<cfset styles="validation.css">
		<cfset scripts="">
