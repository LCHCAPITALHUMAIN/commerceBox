...
<cfcomponent displayname="xslt" output="no" extends="coldbox.system.plugin" cache="true">
<cfset e = StructNew()>
											  	
<!-- MM_XSLTransform errors -->	  	
	<cfset StructInsert(e, 'MM_GEN_ERROR', 'XSL Transform error.<br>')>
	<cfset StructInsert(e, 'MM_XML_EMPTY_ERROR', 'The XSLT source cannot be empty.')>
	<cfset StructInsert(e, 'MM_XSL_EMPTY_ERROR', 'The XSLT source cannot be empty.')>
	<cfset StructInsert(e, 'MM_OPEN_REMOTE_ERROR', 'Error opening %s.<br>')>
	<cfset StructInsert(e, 'MM_OPEN_FILE_ERROR', 'The specified file %s could not be found.<br>')>
	<cfset StructInsert(e, 'MM_INVALID_XML_ERROR', '%s is not a valid XML document.<br>')>
	<cfset StructInsert(e, 'MM_INVALID_XSL_ERROR', '%s is not a valid XSL document.<br>')>
	<cfset StructInsert(e, 'MM_TRANSFORMATION_ERROR', 'Transformation Error.<br>')>
<!-- /MM_XSLTransform errors -->

	<cffunction name="init" access="public" returntype="xslt" output="false">
