...
var serverSideFile = 'index.cfm?event=poll.doVote';
var voteLeftImage = '/includes/images/poller/graph_left_1.gif';
var voteRightImage = '/includes/images/poller/graph_right_1.gif';
var voteCenterImage = '/includes/images/poller/graph_middle_1.gif';
...
function showVoteResults(pollId,ajaxIndex)
{
	...
	document.getElementById('poller_results').style.display='block';
	
	var xml = ajaxObjects[ajaxIndex].response;
	xml = xml.replace(/\n/gi,'');
	
	var reg = new RegExp("^.*?<pollerTitle>(.*?)<.*$","gi");
	var pollerTitle = 'Poll Results';
