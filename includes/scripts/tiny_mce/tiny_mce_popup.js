...
TinyMCE_Popup.prototype = {
	...
	init : function() {
		...
		document.write('<link href="../../../scripts/tiny_mce/' + tinyMCE.getParam("popups_css") + '" rel="stylesheet" type="text/css">');
		...
		if (tinyMCE.getParam("popups_css_add")) {
			...
			document.write('<link href="../../../scripts/tiny_mce/' + c + '" rel="stylesheet" type="text/css">');
		}
