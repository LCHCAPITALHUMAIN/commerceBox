...
function TinyMCE_ContextMenu(settings) {
	...
	if (tinyMCE.isMSIE && !tinyMCE.isMSIE5_0 && !tinyMCE.isOpera) {
		...
		doc.open();
		doc.write('<html><head><link href="../../../../../scripts/tiny_mce/plugins/contextmenu/' + tinyMCE.baseURL + '/plugins/contextmenu/css/contextmenu.css" rel="stylesheet" type="text/css" /></head><body unselectable="yes" class="contextMenuIEPopup"></body></html>');
		doc.close();
	}
};
...
TinyMCE_ContextMenu.prototype = {
	...
	addSeparator : function() {
		this.html += '<tr class="contextMenuItem"><td class="contextMenuIcon"><img src="../../../../../scripts/tiny_mce/plugins/contextmenu/' + this.settings['spacer_image'] + '" width="20" height="1" class="contextMenuImage" /></td><td><img class="contextMenuSeparator" width="1" height="1" src="../../../../../scripts/tiny_mce/plugins/contextmenu/' + this.settings['spacer_image'] + '" /></td></tr>';
	},
	...
	addItem : function(icon, title, command, value, disabled) {
		...
		html += '<td class="contextMenuIcon"><img src="../../../../../scripts/tiny_mce/plugins/contextmenu/' + icon + '" width="20" height="20" class="contextMenuImage" /></td>';
