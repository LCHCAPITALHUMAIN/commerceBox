...
MCWindows.prototype.open = function(url, name, features) {
	...
	html += '      <a href="javascript:parent.mcWindows.windows[\'' + name + '\'].close();" onmousedown="return false;" class="mceWindowClose"><img border="0" src="../../../../../../scripts/tiny_mce/plugins/inlinepopups/jscripts/tiny_mce/themes/advanced/images/window_close.gif" /></a>';
...
//	html += '      <a href="javascript:mcWindows.windows[\'' + name + '\'].minimize();" onmousedown="return false;" class="mceWindowMinimize"></a>';
	...
	html += '<div id="' + id + '_resize" class="mceWindowResize"><img onmousedown="parent.mcWindows.windows[\'' + name + '\'].focus();" border="0" src="../../../../../../scripts/tiny_mce/plugins/inlinepopups/jscripts/tiny_mce/themes/advanced/images/window_resize.gif" /></div>';
	html += '</div>';
	html += '</div>';
