...
TinyMCE_Windows.prototype.open = function(url, name, features) {
	...
	html += '      <a href="javascript:parent.mcWindows.windows[\'' + name + '\'].close();" target="_self" onmousedown="return false;" class="mceWindowClose"><img border="0" src="../../../../../scripts/tiny_mce/plugins/inlinepopups/' + imgPath + '/window_close.gif" /></a>';
	if (features['resizable'] == "yes" && features['maximizable'] == "yes")
		html += '      <a href="javascript:parent.mcWindows.windows[\'' + name + '\'].maximize();" target="_self" onmousedown="return false;" class="mceWindowMaximize"><img border="0" src="../../../../../scripts/tiny_mce/plugins/inlinepopups/' + imgPath + '/window_maximize.gif" /></a>';
	...
	if (features['statusbar'] == "yes") {
		...
		if (features['resizable'] == "yes") {
			if (this.isGecko)
				...
				html += '<div id="' + id + '_resize" class="mceWindowResize"><img onmousedown="parent.mcWindows.windows[\'' + name + '\'].focus();" border="0" src="../../../../../scripts/tiny_mce/plugins/inlinepopups/' + imgPath + '/window_resize.gif" /></div>';
		}
...
TinyMCE_Windows.prototype.setDocumentLock = function(state) {
	...
	if (state) {
		...
		elm.innerHTML = '<img src="../../../../../scripts/tiny_mce/plugins/inlinepopups/' + imgPath + '/spacer.gif" width="' + width + '" height="' + height + '" />';
