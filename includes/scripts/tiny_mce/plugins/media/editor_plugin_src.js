	...
	cleanup : function(type, content, inst) {
		...
		switch (type) {
			case "insert_to_editor":
				...
				content = content.replace(/<script[^>]*>\s*write(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia)\(\{([^\)]*)\}\);\s*<\/script>/gi, '<img class="mceItem$1" title="$2" src="../../../../../scripts/tiny_mce/plugins/media/' + img + '" />');
