...
var TinyMCE_AdvancedTheme = {
	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			...
			case "|":
			case "separator":
				return '<img src="../../../../../scripts/tiny_mce/themes/advanced/{$themeurl}/images/separator.gif" width="2" height="20" class="mceSeparatorLine" alt="" />';

			case "spacer":
				return '<img src="../../../../../scripts/tiny_mce/themes/advanced/{$themeurl}/images/separator.gif" width="2" height="15" border="0" class="mceSeparatorLine" style="vertical-align: middle" alt="" />';
	...
	_insertLink : function(href, target, title, onclick, style_class) {
		...
		if (!tinyMCE.linkElement && tinyMCE.selectedInstance) {
			if (tinyMCE.isSafari) {
				tinyMCE.execCommand("mceInsertContent", false, '<a href="../../../../../scripts/tiny_mce/themes/advanced/' + tinyMCE.uniqueURL + '">' + tinyMCE.selectedInstance.selection.getSelectedHTML() + '</a>');
			} else
